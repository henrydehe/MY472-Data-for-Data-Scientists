...
```{r}
authentication <- list(consumer_key = "xxx",
                 consumer_secret = "xxx",
                 access_token = "xxx",
...
```{r}
# save(authentication, file = "//Users//henrydehe//OneDrive//LSE Year 2//MY472 Data for Data Scientists//Authentication Keys//Twitter//myauthentication.rda")
```
...
```{r}
load("//Users//henrydehe//OneDrive//LSE Year 2//MY472 Data for Data Scientists//Authentication Keys//Twitter//myauthentication.rda")
```
...
twitter_token <- create_token(app = "Week05_guided_coding", 
