...
ip_and_unemployment <- read_csv("/Users/henrydehe/OneDrive/LSE Year 2/MY472 Data for Data Scientists/Github Repositories/lse-my472.github.io/week02/ip_and_unemployment.csv")
...
ipu_clean %>%
  mutate(ip_sq = sq((ip-lag(ip))/lag(ip))),
